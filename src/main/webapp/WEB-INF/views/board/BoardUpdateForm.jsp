...
<div class="container board-list m-full"">
	...
	<div class="container board">
		<form method="post" name="updateForm" action="BoardUpdateAction.bo?page=${pageNum}">
			<input type="hidden" name="board_Num" value="${board.board_Num}"/>
	 		<input type="hidden" name="board_ID" value="${sessionScope.sessionID}">
	 		<input type="hidden" name="board_NickName" value="${sessionScope.sessionNickName}">
 			<div class="form-group">
 			<input class="form-control" type="text" maxlength="100" name="board_Title" id="formTitle" value="${board.board_Title}">
 			</div>
 			<div class="form-group">
